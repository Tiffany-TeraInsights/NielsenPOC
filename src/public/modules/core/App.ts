...
/// <reference path="../../modules/core/controllers/RegisterCtrl.ts" />
/// <reference path="../../modules/core/controllers/LoginCtrl.ts" />
...
url: "/return",
templateUrl: "modules/core/views/register.return.html"
})
.state('login',{
url: "/login",
template: "<ui-view />",
...
.state('todos',{
url: "/adminMain",
templateUrl: "modules/admin/views/admin-main.html",
controller: "TodoCtrl",
controllerAs: "ctrl"
})
;
